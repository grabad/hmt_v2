function [meth_withinc,mdistz,ac_within_ac_c,adistz]=find_within2(xm,ym,zm,xa,ya,za,px,cell_img2bin,xm2,ym2,xa2,ya2)
...
for n2=1:length(xa)
    if cell_img2bin(floor(xa2(n2))+1,floor(ya2(n2))+1)==0
        xa(n2)=nan;
        ya(n2)=nan;
    end
end
